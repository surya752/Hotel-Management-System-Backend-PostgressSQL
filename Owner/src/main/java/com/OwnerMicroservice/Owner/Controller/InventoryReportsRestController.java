...
import com.OwnerMicroservice.Owner.Entity.InventoryReports;
...
public class InventoryReportsRestController {
    @Autowired
    ...
    public String fetchinventory(@PathVariable("id") int id){
