...
import com.ManagerMicroservice.Manager.Entity.Room;
...
public class RoomRestController {
    ...
    public String fetchroom(@PathVariable("id") int id){
    ...
    public String deleteRoom(@PathVariable("id") int id, @RequestBody Room room ) {
